...
class UDamageType;
class AController;
#ifdef VIRUSP_HealthComponent_generated_h
...
public: \
	DECLARE_CLASS(UHealthComponent, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/VirusP"), NO_API) \
...
template<> VIRUSP_API UClass* StaticClass<class UHealthComponent>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_VirusP_Source_VirusP_Public_HealthComponent_h
